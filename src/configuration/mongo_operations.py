...
from src.constant import MONGODB_URL
...
class MongoDBOperation:
    ...
    def get_database(self,db_name)->Database:
        ...
        try:
            ...
            logging.info("Exited get_database method MongoDB operation class")
            return db
    ...
    def insert_dataframe_as_record(self,data_frame,db_name,collection_name)->None:
        ...
        logging.info("Entered insert_dataframe_as_record_method of MongoDB_operation")
